...
# Alias Unix commands
alias ls="eza --classify --all --group-directories-first --long --git --no-time" # lsd https://github.com/lsd-rs/lsd is an alternative to eza worth exploring one day
alias cat=bat
alias less=bat
...
function cl() {
  claude --add-dir "$GIT_PROJECTS_WORKDIR/" "$@"
}
